...
<div class="single-post" id="timeline_single_message<?=$post['PostId']?>">
    <div class="post-athor"><a href="<?=$profile_link?>"><img src="<?=$post_avatar?>" style="width: 50px; height: 50px; border-radius: 50px;" /></a></div>
        <div class="post-content">
            ...
            <ul class="list-inline font-xs">
                <li>
                        <a class="text-info" href="javascript:void(0);"><i class=" glyphicon glyphicon-share-alt"></i> Reply</a>
                </li>
                <li>
                        <a class="text-danger" href="javascript:void(0);"><i class=" glyphicon glyphicon-thumbs-up"></i> Like</a>
                </li>
                <li>
                        <a class="text-muted" href="javascript:void(0);">Show All Comments (14)</a>
                </li>
                <li>
                        <a class="text-primary" href="javascript:void(0);">Edit</a>
                </li>
                <li>
            ...
            <div class="single-post" id="timeline_single_message<?=$post['PostId']?>">
                <div class="post-athor"><a href="<?=$profile_link?>"><img src="<?=$post_avatar?>"></a></div>
                <div class="post-content">
                    <h1><?=$name?></h1>
                    <p><?=$content?></p>
                </div>
            ...
            <div class="post-area">
                <div class="input-group">
                  <textarea class="form-control" placeholder="type a comment here..." style="height:50px"></textarea>
                  <span class="input-group-btn">
                    <button class="btn btn-default" type="button">Replay</button>
                  </span>
                </div> 
            </div>
        </div>
