...
class CAREER_SYSTEM
{
    ...
    public function container($data,$view_type='ECHO'){
          ...
          $return .= $this->CI->load->view('career_system/navigation','',TRUE);
          $return .= $this->CI->load->view('career_system/main_container','',TRUE);
          ...
          if(is_array($data)){
            ...
            $return .= $this->CI->load->view('career_system/main_container_close',NULL,TRUE);
